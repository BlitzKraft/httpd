...
<body>
	...
	<h3>Action List 1</h3>
	<button id="129" onclick="buttonClick(this.id)" class="button touchbutton">Rt Arm Up</button>
	<button id="132" onclick="buttonClick(this.id)" class="button touchbutton">Rt Arm Down</button>
	<button id="133" onclick="buttonClick(this.id)" class="button touchbutton">Rt Arm In</button>
	<button id="130" onclick="buttonClick(this.id)" class="button touchbutton">Rt Arm Out</button>
	<button id="131" onclick="buttonClick(this.id)" class="button touchbutton">Tilt Body Rt</button>
	<button id="137" onclick="buttonClick(this.id)" class="button touchbutton">Lt Arm Up</button>
	<button id="140" onclick="buttonClick(this.id)" class="button touchbutton">Lt Arm down</button>
	<button id="141" onclick="buttonClick(this.id)" class="button touchbutton">Lt Arm In</button>
	<button id="138" onclick="buttonClick(this.id)" class="button touchbutton">Lt Arm Out</button>
	<button id="139" onclick="buttonClick(this.id)" class="button touchbutton">Tilt Body Lt</button>
	<button id="128" onclick="buttonClick(this.id)" class="button touchbutton">Turn Rt</button>
	<button id="136" onclick="buttonClick(this.id)" class="button touchbutton">Turn Lt</button>
	...
	<button id="169" onclick="buttonClick(this.id)" class="button touchbutton">Lt Hand Thump</button>
	...
	<button id="170" onclick="buttonClick(this.id)" class="button touchbutton">Lt Hand Throw</button>
	<button id="171" onclick="buttonClick(this.id)" class="button touchbutton">Listen</button>
	<button id="160" onclick="buttonClick(this.id)" class="button touchbutton">Rt Turn Step</button>
	<button id="168" onclick="buttonClick(this.id)" class="button touchbutton">Lt Turn Step</button>
	<button id="166" onclick="buttonClick(this.id)" class="button touchbutton">Forward Step</button>
	...
	<button id="193" onclick="buttonClick(this.id)" class="button touchbutton">Rt Hand Sweep</button>
	...
	<button id="201" onclick="buttonClick(this.id)" class="button touchbutton">Lt Hand Sweep</button>
	<button id="204" onclick="buttonClick(this.id)" class="button touchbutton">Talk Back</button>
	<button id="205" onclick="buttonClick(this.id)" class="button touchbutton">Lt Hand Strike 1</button>
	<button id="202" onclick="buttonClick(this.id)" class="button touchbutton">Whistle</button>
	<button id="203" onclick="buttonClick(this.id)" class="button touchbutton">Lt Hand Strike 2</button>
	<button id="192" onclick="buttonClick(this.id)" class="button touchbutton">Rt Hand Strike 3</button>
	<button id="200" onclick="buttonClick(this.id)" class="button touchbutton">Lt Hand Strike 3</button>
