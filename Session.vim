...
noremap ,np :!mpc prev -q 
noremap ,nn :!mpc next -q 
noremap ,nP :!mpc toggle -q 
...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/emmet-vim,~/.vim/bundle/vim-material-theme,~/.vim/bundle/vim-arduino-ino,~/.vim/bundle/vim-arduino-syntax,~/.vim/bundle/vim-processing,~/.vim/bundle/powerline/powerline/bindings/vim/,~/.vim/bundle/css.vim,~/.vim/bundle/vim-less,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/emmet-vim/after,~/.vim/bundle/vim-material-theme/after,~/.vim/bundle/vim-arduino-ino/after,~/.vim/bundle/vim-arduino-syntax/after,~/.vim/bundle/vim-processing/after,~/.vim/bundle/powerline/powerline/bindings/vim//after,~/.vim/bundle/css.vim/after,~/.vim/bundle/vim-less/after
set showbreak=↪
set showcmd
set showtabline=2
...
silent only
cd ~/Documents/Persona-BitBucket/httpd
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 cgi-bin/css.less
badd +32 cgi-bin/persona.html
badd +51 cgi-bin/vimper.pde
args cgi-bin/css.less cgi-bin/persona.html
edit cgi-bin/css.less
...
silent! normal! zE
let s:l = 89 - ((45 * winheight(0) + 23) / 47)
